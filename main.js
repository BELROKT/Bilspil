...
Environment.prototype = {
	...
	,buildRoad: function(position,length,angle,width) {
		...
		this.boxList.push(new Box(position,length,width,angle,"#505554"));
		this.boxList.push(new Box(position,length,width - 10,angle,"#606665"));
	}
	,buildRoadCorner: function(position,angle,length,width) {
		...
		this.boxList.push(new Box(position,length,width,angle,"#505554"));
		this.boxList.push(new Box(position,length - 10,width - 10,angle,"#606665"));
	}
};
var Main = function() { };
Main.main = function() {
